...
const ReviewExercise: React.FC<ReviewExerciseProps> = ({ exercise, answers, onBack }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white p-6 md:p-8 rounded-xl shadow-lg">
            <h1 className="text-3xl md:text-4xl font-bold text-center text-sky-700 mb-2">Xem lại: {exercise.title}</h1>
            ...
            <div className="space-y-8">
                {exercise.questions.map((q, index) => {
                    ...
                    return (
                        <div key={q.id} className={`p-6 rounded-lg border ${containerClasses} transition-all`}>
